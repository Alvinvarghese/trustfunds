...
export default function PublicBanner(props) {
  return (
    <div className="text-md mb-8 flex w-full flex-col lg:flex-row items-start justify-center lg:gap-2 rounded-sm bg-lightblue px-3 py-2 font-medium text-primary">
      <AdminCheck />
      <span>
...
export const PrivateBanner = (props) => {
  return (
    <div className="text-md mb-8 flex w-full flex-col lg:flex-row items-start justify-center lg:gap-2 rounded-sm bg-secondary px-3 py-2 font-medium text-secondary-foreground">
      <AdminCheck />
      <span>
